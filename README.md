...
### v2.1.5 (2025-10-04) - 메인 공지사항 UI 배경색 통일 및 디자인 개선
- 🎨 **배경색 통일**: 메인 공지사항 화면의 배경을 일반 화면과 동일한 #f5f5f5로 변경
- 💫 **디자인 개선**: 그라디언트 배경 제거 및 불필요한 그림자 효과 제거로 깔끔한 단색 디자인
- 📝 **텍스트 색상 최적화**: 배경색 변경에 맞춰 텍스트 색상을 #333으로 통일
- ✅ **일관된 UX**: 메인 공지사항 활성 시에도 일반 화면과 동일한 디자인 언어 유지
- 🔧 **코드 정리**: 필요 없는 그라디언트 및 그림자 효과 완전 제거
...
- 🔍 **디버깅 로그**: 메인 공지사항에서 PIN 상태 추적 로그 추가
- ⚡ **실시간 업데이트**: 메인 공지사항 화면의 PIN 목록 실시간 동기화 개선
- 🎯 **문제 해결**: PIN이 연결되어도 메인 공지사항에서 표시되지 않는 문제 수정
